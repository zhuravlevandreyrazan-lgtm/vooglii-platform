...
def test_update_text_and_sync_views_show_moscow_time():
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        sync_state.save_sync_state(42, "advertising", "API_LIMIT", status_reason="ADS_COOLDOWN:300", next_allowed_at="2026-07-07 20:21:15")
        ...
        sync_queue.enqueue_sync_task(42, "advertising", "2026-07-01", "2026-07-31", status=sync_queue.QUEUE_WAIT_LIMIT, run_after="2026-07-07 20:21:15", last_error="ADS_COOLDOWN:300")
        ...
        sync_queue.record_sync_history(42, "advertising", "API_LIMIT", source_rows=0, retry_at="2026-07-07 20:21:15", message="ADS_COOLDOWN:300")
        ...
        update_text = sync_service.format_sync_result(
            {
                ...
                "blocks": {
                    ...
                    "advertising": {"status": "API_LIMIT", "raw_status": "ADS_COOLDOWN:300", "next_allowed_at": "2026-07-07 20:21:15"},
